<svelte:head>
  <title>Terms & Conditions | Blulux Shop</title>
</svelte:head>
<div class="container">
  <div>
    <h2>LAST UPDATED: JUNE 22, 2021</h2>
    <p>
      Please read these Terms of Use ("Terms", "Terms of Use") carefully before
      using the <a href="https://bluluxshop.com/">https://bluluxshop.com/</a> website
      (the "Service") operated by Bluluxshop, LTD. ("us", "we" , or "our").
    </p>
    <p>
  ...
  <div>
    ...
    <ul>
      ...
      <li>in connection with any Purchase;</li>
    ...
    <p>
      ...
      third parties subject to our Privacy Policy. We reserve the right to
      refuse or cancel your order at any time for reasons including but not
      limited to: product or service availability, errors in the description or
      price of the product or service, error in your order or other reasons. We
  ...
  <div>
    ...
    <ul>
      <li>
        Bluluxshop, LTD. in its sole discretion and at any time, may modify the
      ...
      <li>
        Bluluxshop, LTD. will provide you with a reasonable prior notice of any
  ...
  <div>
    ...
    <p>
      ...
      vulgar or obscene. We reserve the right to refuse service, terminate
  ...
  <div>
    ...
    <p>
      ...
      constitutes copyright infringement, please submit your claim via email to <a
        href="mailto:bluluxgelsystem@gmail.com">bluluxgelsystem@gmail.com</a
  ...
  <!-- <div>
    ...
    <ul>
      ...
      <li>
        You can contact our Copyright Agent via email at <a
          href="mailto:bluluxgelsystem@gmail.com">bluluxgelsystem@gmail.com</a
        >
      </li>
    </ul>
  ...
  <div>
    ...
    <p>
      ...
      property of Bluluxshop, LTD. and its licensors. The Service is protected
      by copyright, trademark, and other laws of both the UK and foreign
  ...
  <div>
    ...
    <p>
      ...
      are not owned or controlled by Bluluxshop, LTD.
    </p>
    <p>
      Bluluxshop, LTD. has no control over, and assumes no responsibility for
      the content, privacy policies, or practices of any third party web sites
      or services. We do not warrant the offerings of any of these entities
      individuals or their websites.
    </p>
    <p>
      You acknowledge and agree that Bluluxshop, LTD. shall not be responsible
  ...
  <div>
    ...
    <p>
      You agree to defend, indemnify and hold harmless Bluluxshop, LTD. and its
  ...
  <div>
    ...
    <p>
      In no event shall Bluluxshop, LTD. nor its directors, employees, partners,
    ...
    <ul>
      <li>
        your access to or use of or inability to access or use the Service; (II)
  ...
  <div>
    ...
    <p>
      Bluluxshop, LTD. its subsidiaries, affiliates, and its licensors do not
  ...
  <div>
    ...
    <p>
      ...
      London, the United Kingdom, without regard to its conflict of law
      ...
      replace any prior agreements we might have had between us regarding the
      Service.
    </p>
  </div>
  <div>
    ...
    <p>
      ...
      30-day notice prior to any new terms taking effect. What constitutes a
